 ...
 *
 * Every thing works alright pm id is being generated and sent along with the booking id but server unable to process the data
 */
...
function AppPayment() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    if (paymentError) {
      ...
      setPaymentError(
        paymentError.message || "Failed to create payment method"
      );
      return;
    }
    ...
    console.log(paymentMethod.id, paymentDetails.payment_id);
    mutate(
      {
...
export default AppPayment;
    ...
    /*
    (use this in case of real data) to confirm payment
    ...
    //Payment succeeded, send payment id and payment method id to sever
